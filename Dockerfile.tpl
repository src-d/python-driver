...
RUN apk add --no-cache --update python python-dev python3 py-pip py2-pip
...
RUN /usr/local/bin/pip3 install -U ${CONTAINER_DEVDEPS}/python-pydetector || pip3 install pydetector-bblfsh==${PYDETECTOR_VER}
RUN /usr/bin/pip3 install -U ${CONTAINER_DEVDEPS}/python-pydetector || pip3 install pydetector-bblfsh==${PYDETECTOR_VER}
